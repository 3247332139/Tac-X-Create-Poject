...
public class CriteriaTriggers {
   ...
   public static <T extends ICriterionTrigger<?>> T register(T pCriterion) {
   ...
   @Nullable
   public static <T extends ICriterionInstance> ICriterionTrigger<T> getCriterion(ResourceLocation pId) {
      return (ICriterionTrigger<T>) CRITERIA.get(pId);
   }
