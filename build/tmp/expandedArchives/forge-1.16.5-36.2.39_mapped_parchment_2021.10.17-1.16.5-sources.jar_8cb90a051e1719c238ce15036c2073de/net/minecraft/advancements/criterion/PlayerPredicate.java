...
public class PlayerPredicate {
   ...
   private static PlayerPredicate.IAdvancementPredicate advancementPredicateFromJson(JsonElement pElement) {
      if (pElement.isJsonPrimitive()) {
         ...
         JsonObject jsonobject = JSONUtils.convertToJsonObject(pElement, "criterion data");
   ...
   public static PlayerPredicate fromJson(@Nullable JsonElement pElement) {
      if (pElement != null && !pElement.isJsonNull()) {
         JsonObject jsonobject = JSONUtils.convertToJsonObject(pElement, "player");
