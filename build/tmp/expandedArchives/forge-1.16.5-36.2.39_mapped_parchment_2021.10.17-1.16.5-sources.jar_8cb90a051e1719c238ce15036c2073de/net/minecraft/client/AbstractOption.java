...
public abstract class AbstractOption {
   ...
   public AbstractOption(String pCaptionKey) {
      this.caption = new TranslationTextComponent(pCaptionKey);
   }

   public abstract Widget createButton(GameSettings pOptions, int pX, int pY, int pWidth);
   ...
   protected ITextComponent pixelValueLabel(int pValue) {
      return new TranslationTextComponent("options.pixel_value", this.getCaption(), pValue);
   }

   protected ITextComponent percentValueLabel(double pPercentage) {
      return new TranslationTextComponent("options.percent_value", this.getCaption(), (int)(pPercentage * 100.0D));
   }

   protected ITextComponent percentAddValueLabel(int pDoubleValue) {
      return new TranslationTextComponent("options.percent_add_value", this.getCaption(), pDoubleValue);
   }

   protected ITextComponent genericValueLabel(ITextComponent pValueMessage) {
      return new TranslationTextComponent("options.generic_value", this.getCaption(), pValueMessage);
   }

   protected ITextComponent genericValueLabel(int pValue) {
      return this.genericValueLabel(new StringTextComponent(Integer.toString(pValue)));
   }
}