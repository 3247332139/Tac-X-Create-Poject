...
public class MapItemRenderer implements AutoCloseable {
   ...
   class Instance implements AutoCloseable {
      ...
      private void draw(MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, boolean pActive, int pPackedLight) {
         int i = 0;
         int j = 0;
         float f = 0.0F;
         Matrix4f matrix4f = pMatrixStack.last().pose();
         IVertexBuilder ivertexbuilder = pBuffer.getBuffer(this.renderType);
         ivertexbuilder.vertex(matrix4f, 0.0F, 128.0F, -0.01F).color(255, 255, 255, 255).uv(0.0F, 1.0F).uv2(pPackedLight).endVertex();
         ivertexbuilder.vertex(matrix4f, 128.0F, 128.0F, -0.01F).color(255, 255, 255, 255).uv(1.0F, 1.0F).uv2(pPackedLight).endVertex();
         ivertexbuilder.vertex(matrix4f, 128.0F, 0.0F, -0.01F).color(255, 255, 255, 255).uv(1.0F, 0.0F).uv2(pPackedLight).endVertex();
         ivertexbuilder.vertex(matrix4f, 0.0F, 0.0F, -0.01F).color(255, 255, 255, 255).uv(0.0F, 0.0F).uv2(pPackedLight).endVertex();
         int k = 0;
         ...
         for(MapDecoration mapdecoration : this.data.decorations.values()) {
            if (!pActive || mapdecoration.renderOnFrame()) {
               ...
               float f5 = -0.001F;
               IVertexBuilder ivertexbuilder1 = pBuffer.getBuffer(MapItemRenderer.MAP_ICONS);
               ivertexbuilder1.vertex(matrix4f1, -1.0F, 1.0F, (float)k * -0.001F).color(255, 255, 255, 255).uv(f1, f2).uv2(pPackedLight).endVertex();
               ivertexbuilder1.vertex(matrix4f1, 1.0F, 1.0F, (float)k * -0.001F).color(255, 255, 255, 255).uv(f3, f2).uv2(pPackedLight).endVertex();
               ivertexbuilder1.vertex(matrix4f1, 1.0F, -1.0F, (float)k * -0.001F).color(255, 255, 255, 255).uv(f3, f4).uv2(pPackedLight).endVertex();
               ivertexbuilder1.vertex(matrix4f1, -1.0F, -1.0F, (float)k * -0.001F).color(255, 255, 255, 255).uv(f1, f4).uv2(pPackedLight).endVertex();
               ...
               if (mapdecoration.getName() != null) {
                  ...
                  fontrenderer.drawInBatch(itextcomponent, 0.0F, 0.0F, -1, false, pMatrixStack.last().pose(), pBuffer, false, Integer.MIN_VALUE, pPackedLight);
                  pMatrixStack.popPose();
               }
