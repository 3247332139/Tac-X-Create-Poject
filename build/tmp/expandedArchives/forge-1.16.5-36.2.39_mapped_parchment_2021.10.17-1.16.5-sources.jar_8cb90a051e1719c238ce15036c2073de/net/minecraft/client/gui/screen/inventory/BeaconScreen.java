...
public class BeaconScreen extends ContainerScreen<BeaconContainer> {
   ...
   public BeaconScreen(final BeaconContainer pBeaconMenu, PlayerInventory pPlayerInventory, ITextComponent pTitle) {
      super(pBeaconMenu, pPlayerInventory, pTitle);
      this.imageWidth = 230;
      this.imageHeight = 219;
      pBeaconMenu.addSlotListener(new IContainerListener() {
         ...
         public void setContainerData(Container pContainer, int pVarToUpdate, int pNewValue) {
            BeaconScreen.this.primary = pBeaconMenu.getPrimaryEffect();
            BeaconScreen.this.secondary = pBeaconMenu.getSecondaryEffect();
   ...
   protected void renderLabels(MatrixStack pMatrixStack, int pX, int pY) {
      ...
      for(Widget widget : this.buttons) {
         if (widget.isHovered()) {
            widget.renderToolTip(pMatrixStack, pX - this.leftPos, pY - this.topPos);
            break;
         }
      }
   ...
   abstract static class Button extends AbstractButton {
      ...
      protected Button(int pX, int pY) {
      ...
      protected abstract void renderIcon(MatrixStack pPoseStack);
   ...
   class CancelButton extends BeaconScreen.SpriteButton {
      ...
      public void renderToolTip(MatrixStack pPoseStack, int pMouseX, int pMouseY) {
         BeaconScreen.this.renderTooltip(pPoseStack, DialogTexts.GUI_CANCEL, pMouseX, pMouseY);
      }
   }
   ...
   class ConfirmButton extends BeaconScreen.SpriteButton {
      ...
      public void renderToolTip(MatrixStack pPoseStack, int pMouseX, int pMouseY) {
         BeaconScreen.this.renderTooltip(pPoseStack, DialogTexts.GUI_DONE, pMouseX, pMouseY);
      }
   }
