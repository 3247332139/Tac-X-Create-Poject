...
public class StriderRenderer extends MobRenderer<StriderEntity, StriderModel<StriderEntity>> {
    ...
    */
   public ResourceLocation getTextureLocation(StriderEntity pEntity) {
      return pEntity.isSuffocating() ? COLD_LOCATION : STRIDER_LOCATION;
   }

   protected void scale(StriderEntity pLivingEntity, MatrixStack pMatrixStack, float pPartialTickTime) {
