...
public class GameProfileArgument implements ArgumentType<GameProfileArgument.IProfileProvider> {
   ...
   public static Collection<GameProfile> getGameProfiles(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
      return pContext.getArgument(pName, GameProfileArgument.IProfileProvider.class).getNames(pContext.getSource());
   }
   ...
   public static class ProfileProvider implements GameProfileArgument.IProfileProvider {
      ...
      public ProfileProvider(EntitySelector pSelector) {
