...
public class PotionArgument implements ArgumentType<Effect> {
   ...
   public static Effect getEffect(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
      return pContext.getArgument(pName, Effect.class);
   }
