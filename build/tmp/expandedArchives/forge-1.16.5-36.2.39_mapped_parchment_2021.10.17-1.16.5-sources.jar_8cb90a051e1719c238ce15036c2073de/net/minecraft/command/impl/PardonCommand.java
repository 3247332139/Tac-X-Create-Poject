...
public class PardonCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> pDispatcher) {
      pDispatcher.register(Commands.literal("pardon").requires((p_198551_0_) -> {
   ...
   private static int pardonPlayers(CommandSource pSource, Collection<GameProfile> pGameProfiles) throws CommandSyntaxException {
      ...
      for(GameProfile gameprofile : pGameProfiles) {
         if (banlist.isBanned(gameprofile)) {
            ...
            ++i;
            pSource.sendSuccess(new TranslationTextComponent("commands.pardon.success", TextComponentUtils.getDisplayName(gameprofile)), true);
         }
      }
