...
public class BlockTagsProvider extends TagsProvider<Block> {
   @Deprecated
   public BlockTagsProvider(DataGenerator pGenerator) {
      super(pGenerator, Registry.BLOCK);
   }
   public BlockTagsProvider(DataGenerator pGenerator, String modId, @javax.annotation.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
   ...
   protected Path getPath(ResourceLocation pId) {
      return this.generator.getOutputFolder().resolve("data/" + pId.getNamespace() + "/tags/blocks/" + pId.getPath() + ".json");
   }
