...
public class SChunkDataPacket implements IPacket<IClientPlayNetHandler> {
   ...
   public void write(PacketBuffer pBuffer) throws IOException {
      ...
      pBuffer.writeBoolean(this.fullChunk);
      pBuffer.writeVarInt(this.availableSections);
      ...
      pBuffer.writeVarInt(this.blockEntitiesTags.size());

      for(CompoundNBT compoundnbt : this.blockEntitiesTags) {
         pBuffer.writeNbt(compoundnbt);
      }
