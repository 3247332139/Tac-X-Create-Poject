...
public class TestTracker {
   ...
   public TestTracker(TestFunctionInfo pFunction, Rotation pRotation, ServerWorld pServerLevel) {
   ...
   public void addListener(ITestCallback pListener) {
      this.listeners.add(pListener);
   }

   public void spawnStructure(BlockPos pPos, int p_240543_2_) {
      StructureBlockTileEntity structureblocktileentity = StructureHelper.spawnStructure(this.getStructureName(), pPos, this.getRotation(), p_240543_2_, this.level, false);
