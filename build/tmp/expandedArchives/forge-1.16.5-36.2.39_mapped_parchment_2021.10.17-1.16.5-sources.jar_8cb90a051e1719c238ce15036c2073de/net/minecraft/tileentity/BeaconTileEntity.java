...
public class BeaconTileEntity extends TileEntity implements INamedContainerProvider, ITickableTileEntity {
   ...
   private final IIntArray dataAccess = new IIntArray() {
      ...
      public void set(int pIndex, int pValue) {
         switch(pIndex) {
         case 0:
            BeaconTileEntity.this.levels = pValue;
            break;
         case 1:
            ...
            BeaconTileEntity.this.primaryPower = BeaconTileEntity.getValidEffectById(pValue);
            break;
         case 2:
            BeaconTileEntity.this.secondaryPower = BeaconTileEntity.getValidEffectById(pValue);
         }
   ...
   @Nullable
   private static Effect getValidEffectById(int pEffectId) {
      Effect effect = Effect.byId(pEffectId);
   ...
   public CompoundNBT save(CompoundNBT pCompound) {
      ...
      pCompound.putInt("Primary", Effect.getId(this.primaryPower));
      pCompound.putInt("Secondary", Effect.getId(this.secondaryPower));
   ...
   public static class BeamSegment {
      ...
      public BeamSegment(float[] pColor) {
         this.color = pColor;
         this.height = 1;
      }
