...
public class BlockClusterFeatureConfig implements IFeatureConfig {
   ...
   private BlockClusterFeatureConfig(BlockStateProvider pStateProvider, BlockPlacer pBlockPlacer, Set<Block> pWhitelist, Set<BlockState> pBlacklist, int pTries, int pXspread, int pYspread, int pZspread, boolean pCanReplace, boolean pProject, boolean pNeedWater) {
      this.stateProvider = pStateProvider;
      this.blockPlacer = pBlockPlacer;
      ...
      this.canReplace = pCanReplace;
      this.project = pProject;
      this.needWater = pNeedWater;
   }
   ...
   public static class Builder {
      ...
      public Builder(BlockStateProvider pStateProvider, BlockPlacer pBlockPlacer) {
         this.stateProvider = pStateProvider;
         this.blockPlacer = pBlockPlacer;
      }

      public BlockClusterFeatureConfig.Builder whitelist(Set<Block> pWhitelist) {
         this.whitelist = pWhitelist;
         return this;
      }

      public BlockClusterFeatureConfig.Builder blacklist(Set<BlockState> pBlacklist) {
         this.blacklist = pBlacklist;
         return this;
      }

      public BlockClusterFeatureConfig.Builder tries(int pTries) {
         this.tries = pTries;
         return this;
      }

      public BlockClusterFeatureConfig.Builder xspread(int pXSpread) {
         this.xspread = pXSpread;
         return this;
      }

      public BlockClusterFeatureConfig.Builder yspread(int pYSpread) {
         this.yspread = pYSpread;
         return this;
      }

      public BlockClusterFeatureConfig.Builder zspread(int pZSpread) {
         this.zspread = pZSpread;
         return this;
      }
