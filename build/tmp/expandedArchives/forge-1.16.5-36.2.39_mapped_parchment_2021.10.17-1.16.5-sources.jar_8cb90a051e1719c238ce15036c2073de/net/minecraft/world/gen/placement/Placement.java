...
public abstract class Placement<DC extends IPlacementConfig> extends net.minecraftforge.registries.ForgeRegistryEntry<Placement<?>> {
   ...
   private static <T extends IPlacementConfig, G extends Placement<T>> G register(String pKey, G pDecorator) {
      return Registry.register(Registry.DECORATOR, pKey, pDecorator);
   }

   public Placement(Codec<DC> pCodec) {
      this.configuredCodec = pCodec.fieldOf("config").xmap((p_236966_1_) -> {
         return new ConfiguredPlacement<DC>(this, p_236966_1_);
      }, ConfiguredPlacement::config).codec();
   }

   public ConfiguredPlacement<DC> configured(DC pConfig) {
      return new ConfiguredPlacement<>(this, pConfig);
   }
   ...
   public abstract Stream<BlockPos> getPositions(WorldDecoratingHelper pHelper, Random pRandom, DC pConfig, BlockPos pPos);
