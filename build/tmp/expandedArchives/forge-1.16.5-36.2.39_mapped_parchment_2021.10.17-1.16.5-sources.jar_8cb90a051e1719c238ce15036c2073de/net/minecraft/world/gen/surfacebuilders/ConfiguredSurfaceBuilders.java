...
public class ConfiguredSurfaceBuilders {
   ...
   private static <SC extends ISurfaceBuilderConfig> ConfiguredSurfaceBuilder<SC> register(String pId, ConfiguredSurfaceBuilder<SC> pConfiguredSurfaceBuilder) {
      return WorldGenRegistries.register(WorldGenRegistries.CONFIGURED_SURFACE_BUILDER, pId, pConfiguredSurfaceBuilder);
   }
}